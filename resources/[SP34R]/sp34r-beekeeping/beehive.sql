...
-- Dumping database structure for evolve
CREATE DATABASE IF NOT EXISTS `evolve` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `evolve`;

-- Dumping structure for table evolve._beehives
...
-- Dumping data for table evolve._beehives: ~0 rows (approximately)
