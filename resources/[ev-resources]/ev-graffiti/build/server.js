(() => {
    ...
    onNet("ev-graffiti:completePurchase", async (pId) => {
        let src = source
    ...
    DPX.Procedures.register("ev-graffiti:spray", async (src, pModel, pCoords, pRotation, pGandId, pIsGang) => {
      ...
      let CurrGraffiti = {
        ...
        return emitNet('pnp:objects:prepareNewObject', -1, CurrGraffiti), true
    })
})();
